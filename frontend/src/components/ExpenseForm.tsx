...
// export const ExpenseForm = ({ onCreated }: Props) => {
//   // 1. Локальное состояние формы
//   const [form, setForm] = useState({
//     title: "", category: "", price: "", location: "", datetime: ""
//   });
...
//     await createExpense({ ...form, price: parseFloat(form.price) || 0 });
//     setForm({ title: "", category: "", price: "", location: "", datetime: "" });
//     onCreated();
//   };
