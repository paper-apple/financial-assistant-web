...
vi.mock("../../../utils/groupByPeriod", () => ({
  ...
  groupByPeriod: vi.fn(() => [
    { key: "2026-01-01–2023-01-02", total: 100, count: 2 },
    { key: "2026-01-03–2023-01-04", total: 200, count: 3 },
  ]),
}));
...
describe("TimeSeriesChart", () => {
  const expenses = [
    { id: 1, title: "Кофе", category: { id:1, name: "Еда"}, location: { id:1, name: "Кафе"}, price: 5, datetime: "2026-01-01T00:00:00Z" },
    { id: 2, title: "Книга", category: { id:1, name: "Образование"}, location: { id:1, name: "Магазин"}, price: 15, datetime: "2026-01-02T00:00:00Z" },
  ] as Expense[];
  ...
  it("рендер Line с данными и опциями", () => {
    ...
    expect(data.labels).toEqual(["2026-01-01–2023-01-02", "2026-01-03–2023-01-04"]);
    expect(data.datasets[0].label).toBe("expence_amount");
    expect(data.datasets[1].label).toBe("number_of_transactions");
  });
